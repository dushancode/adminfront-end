...
const Home = () => {
  ...
  const cardStyle ={
    backgroundColor: "rgba(#4133B7, .25)",
    borderRadius: "16px",
    boxShadow: "0 30px 30px -25px",
    minHeight: "130px",
  };
    ...
    <Layout active="home">
      <div className="home-main">
        <Row gutter={[16, 16]} align="middle">
          <Col xs={24} lg={6}>
            <div className="stats stat-4" style={cardStyle}>
              <div>
                <span>E Books</span>
                <span>23423</span>
              </div>
          ...
          <Col xs={24} lg={6}>
            <div className="stats stat-2" style={cardStyle}>
              <CountStatistics
                title="Readers"
          ...
          <Col xs={24} lg={6}>
            <div className="stats stat-3" style={cardStyle}>
              <CountStatistics
                title="Net Income"
        ...
        <div className="mt-30" >
          <Row gutter={[16, 30]} >
            <Col xs={24} lg={12} style={gridStyle}>
